...
if (descripcion.value == "ADMINISTRATIVO" || descripcion.value == "DOCENTE" || descripcion.value =="BANACADEMICO")
{
    $("#showTexto").css("display", "block");
}

if (descripcion.value == "ESTUDIANTE" || descripcion.value == "EGRESADO" || descripcion.value == "GRADUADO") {
    $("#showEnlace").css("display", "block");
}
    ...
    if (rbtEmail.checked == false && rbtMobile.checked == false /*&& rbtTengoCodigo.checked == false*/) {
        ...
        $.ajax({
            ...
            success: function (data) {
                //Validate if the process has been successfully completed 
                if (data.isSend == true) {
